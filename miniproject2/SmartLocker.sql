...
values
(15, '고장', '키보드 일부 키가 입력되지 않습니다.', '접수'),
(13, '고장', 'HDMI 출력이 정상적으로 되지 않습니다.', '점검중'),
(17, '파손', '태블릿 화면 모서리에 금이 갔습니다.', '수리중'),
(20, '고장', '아두이노 보드가 과열되고 탄 냄새가 납니다.', '처리완료'),
(19, '파손', '캡처보드 HDMI 단자가 휘어졌습니다.', '접수'),
(12, '고장', '아두이노 USB 연결이 간헐적으로 끊깁니다.', '점검중'),
(13, '고장', '라즈베리파이 전원이 정상적으로 돌아오지 않습니다.', '처리완료'),
(15, '파손', '노트북 충전 단자가 손상되었습니다.', '수리중'),
(17, '고장', '태블릿 터치 입력이 일부 영역에서 되지 않습니다.', '처리완료'),
(20, '파손', '아두이노 보드의 USB 단자가 파손되었습니다.', '접수');